    ...
    <div class="card mt-3">
        ...
        <form action="edit_nilai_act.php" method="post">
            ...
            <div class="card-body">
                ...
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $data = mysqli_query($koneksi, "SELECT ns.id AS id_nilai, u.name, ns.nilai, ns.id_materi, mp.mapel FROM nilai_siswa AS ns 
                    LEFT JOIN user AS u ON ns.id_user = u.id 
                    LEFT JOIN matapelajaran AS mp ON ns.id_materi = mp.id
                    WHERE ns.id = " . $_GET['id'] . "");
                                        ...
                                        <div class="container">
                                            <div class="float-left" style="width: 100%;">
                                                <select name="data_id_materi" id="data_id_materi" class="form-control">
                                                    ...
                                                    <?php
                                                    $datamateri = mysqli_query($koneksi, "SELECT DISTINCT id, mapel FROM matapelajaran WHERE id_guru = " . $_SESSION['id'] . "");
